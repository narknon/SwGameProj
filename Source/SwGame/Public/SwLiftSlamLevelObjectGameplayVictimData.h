...
#include "SwLiftSlamLevelObjectGameplayVictimData.generated.h"

USTRUCT(BlueprintType)
struct FSwLiftSlamLevelObjectGameplayVictimData {
    GENERATED_BODY()
public:
    ...
    SWGAME_API FSwLiftSlamLevelObjectGameplayVictimData();
};
